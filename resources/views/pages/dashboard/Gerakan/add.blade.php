...
<main class="h-full overflow-y-auto">
    ...
    <nav class="mx-10 mt-8 text-sm" aria-label="Breadcrumb">
        <ol class="inline-flex p-0 list-none">
            ...
            <li class="flex items-center">
                <a href="#" class="font-medium">Tambah Gerakan</a>
            </li>
        </ol>
    </nav>
        ...
        <div class="grid gap-5 md:grid-cols-12">
            <main class="col-span-12 p-4 md:pt-0">
                <div class="px-2 py-2 mt-2 bg-white rounded-xl">
                    <form action="{{route('dashboard.tambah')}}" method="POST">
                        @csrf
                        <div class="">
                            <div class="px-4 py-5 sm:p-6">
                                <div class="grid grid-cols-6 gap-6">
                                    <div class="col-span-6">
                                        ...
                                        <input placeholder="Nama gerakannya" type="text" name="nama" id="nama" autocomplete="nama" class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm">
                                    </div>
                                    <div class="col-span-6">
                                        <label for="repitisi" class="block mb-3 font-medium text-gray-700 text-md">Repitisi</label>
                                        <input placeholder="repitisi" type="number" name="repitisi" id="repitisi" autocomplete="repitisi" class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm">
                                    </div>
                                    <div class="col-span-6">
                                        <label for="set" class="block mb-3 font-medium text-gray-700 text-md">Set</label>
                                        <input placeholder="set" type="number" name="set" id="set" autocomplete="set" class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm">
                                    </div>
                                    {{-- <div class="col-span-6">
                                        <label for="Set" class="block mb-2 font-medium text-gray-700 text-md">Set</label>
