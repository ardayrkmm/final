            ...
            <form method="POST" action="{{ route('register.post') }}">
                ...
                <div class="relative p-6 flex-auto mx-10">
                    <div class="mb-4">
                        ...
                        <input name="name" class="appearance-none border border-gray-300 rounded-lg w-full py-3 px-4 placeholder-serv-text text-xs" id="name" type="text" placeholder="Nama Kamu" required>
                    ...
                    <div>
                        ...
                        <input name="password_confirmation" class="appearance-none border border-gray-300 rounded-lg w-full py-3 px-4 placeholder-serv-text text-xs mb-3" id="password_confirmation" type="password_confirmation" placeholder="At least 8 characters" required>
                ...
                <div class="px-6 pb-6 rounded-b-xl mx-10">
                    ...
                    <button class="block text-center color-primary text-white text-lg py-3 px-12 my-2 rounded-lg w-full">
                    Login
                    </button>
